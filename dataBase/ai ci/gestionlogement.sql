...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 04 juin 2024 à 11:26
...
CREATE TABLE IF NOT EXISTS `image_logement` (
  ...
  `chemin_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT './image/house picture.jpg',
...
CREATE TABLE IF NOT EXISTS `mode_payement` (
  ...
  `lib_modePay` varchar(20) NOT NULL,
